...
I have implemented this control design in Robocomp framework with Coppellia Sim simulatior. I follows a trajectory generated by A-star algorithm. Visually it performs better than the existing Stanley Controller.

![Performance with existing Stanley Controller](./Media/existing.mp4)
![Performance with Sliding Mode Controller](./Media/ASMC.mp4)